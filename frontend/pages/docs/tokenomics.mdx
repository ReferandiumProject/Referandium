...
Referandium operates on a **pure SOL economy** with a unique **refundable rental model** for Gookies. Unlike traditional NFT marketplaces or prescription markets, our system prioritizes **capital efficiency** and **sustainable revenue generation** through platform fees, not ownership sales.
